...
在等待 LMDeploy 的 api_server 与 AgentLego WebUI 完全启动后，在**本地**进行端口映射，将 LMDeploy api_server 的23333端口以及 AgentLego WebUI 的7860端口映射到本地。可以执行：
...
![tool_config](images/tool_config.png)
...
![object_detect_result](images/object_detect_result.png)
### 用 AgentLego 自定义工具
...
我们在两个 terminal 中分别启动 LMDeploy 服务和 AgentLego 的 WebUI 以体验我们自定义的工具的效果。
...
![image_generate_result](images/image_generate_result.png)
