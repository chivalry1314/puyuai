...
```
整个评测在10% A100上会花费75分钟左右。

评测起始时间：
![infer_start](images/infer_start.png)

评测结束时间：
![infer_end](images/infer_end.png)

评测完成后，将会看到：

![评测结果](images/infer_result.png)
